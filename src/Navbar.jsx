                                    ...
                                    <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                                        ...
                                        <li className="nav-item dropdown">
                                            ...
                                            <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                                ...
                                                <li><NavLink activeClassName='menu_active' className="dropdown-item" to="#">Tv</NavLink></li>
                                                <li><hr className="dropdown-divider" /></li>
                                                <li><NavLink activeClassName='menu_active' className="dropdown-item" to="#">Games</NavLink></li>
                                                <li><hr className="dropdown-divider" /></li>
                                                <li><NavLink activeClassName='menu_active' className="dropdown-item" to="#">Instrument</NavLink></li>
                                            </ul>
                                        </li>
